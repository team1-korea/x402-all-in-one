...
contract UsdcToken {
    ...
    function transferWithAuthorization(
        ...
        require(block.timestamp > validAfter, "USDC: auth not yet valid");
        require(block.timestamp < validBefore, "USDC: auth expired");
        require(!authorizationState[from][nonce], "USDC: nonce already used");
