...
const Slide11Go = ({ animKey }: Props) => (
  <div className="slide bg-beige content-z-index">
    ...
    <div key={animKey} className="flex flex-col items-center w-full content-z-index">
      <p className="fade-in-stagger font-mono text-sm tracking-widest uppercase text-sage mb-6" style={{ animationDelay: '0s' }}>07 · Marathon</p>
      <div className="fade-in-stagger font-serif text-[12vw] font-bold text-terracotta leading-none mb-2" style={{ animationDelay: '0.2s' }}>
        GO
      </div>
      <div className="fade-in-stagger font-mono text-lg tracking-[0.3em] uppercase text-sage mb-10" style={{ animationDelay: '0.6s' }}>
        QUEST MARATHON
      </div>
      ...
      <div className="fade-in-stagger bg-terracotta/5 border border-terracotta/25 rounded-xl px-8 py-5 font-sans text-lg text-terracotta/90 text-center" style={{ animationDelay: '1.2s' }}>
