...
const items = [
  { label: '클로드에게 결제 능력 심어주기', sub: 'SKILL.md 구멍을 채워 스킬을 장착시킵니다' },
  { label: '퀘스트 실전 훈련 — 10판 완주', sub: '실시간 순위, 잘 가르친 보호자 Top 3에게 선물' },
  { label: '내 플랫폼에 돈 내러 오는 AI 만들기', sub: '오늘 자리를 뜨면, 우리 클로드 독립합니다' },
]
